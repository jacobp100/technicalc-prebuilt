...
keys->Js.Dict.set("+", key(~value=One(`Operator(Add)), ~flags=none));
keys->Js.Dict.set("-", key(~value=One(`Operator(Sub)), ~flags=none));
keys->Js.Dict.set("*", key(~value=One(`Operator(Mul)), ~flags=none));
keys->Js.Dict.set("/", key(~value=One(`Operator(Div)), ~flags=none));
...
keys->Js.Dict.set("pi", key(~value=One(`ConstantS(Pi)), ~flags=none));
keys->Js.Dict.set("e", key(~value=One(`ConstantS(E)), ~flags=none));
...
keys->Js.Dict.set("dot", key(~value=One(`Operator(Dot)), ~flags=none));
